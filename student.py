...
class Student:
    def __init__(self,main):
        ...
        self.Frame_1=Frame(self.main,height="580", width="500", bd=2, relief=GROOVE, bg="green")
    ...
    ##################### Button #################################
        ...
        self.tree.insert("", index=0, values=(20222131506101, "Aarthi", 20, "12-03-2003","Female", "Thisaiyanvillai"))
        self.tree.pack()
